...
const Food = () => {
    ...
    return (
        <div className="max-w-[1640px] m-auto px-4 py-12">
            <h1 className="text-orange-600 font-bold text-4xl text-center">Top Rated Food Menu Items</h1>
            <div className="flex flex-col lg:flex-row justify-between">
                ...
                <div>
                    ...
                    <div className="flex justify-between flex-wrap">
                        ...
                        <button onClick={()=>filterType("pizza")} className="m-1 border-orange-600 hover:bg-orange-600 hover:text-white">Pizzas</button>
